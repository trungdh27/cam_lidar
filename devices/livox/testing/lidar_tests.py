...
from devices.livox.testing.ros2_executors import ROS2_EXECUTORS
from devices.livox.testing.source_catalog import load_source_test_definitions
...
def build_lidar_test_registry(profile) -> TestRegistry:
    ...
    source_executors = dict(ROS2_EXECUTORS)
    source_executors["guided"] = GuidedWorkflowExecutor
    registry.register_many(load_source_test_definitions(source_executors))
    return registry
